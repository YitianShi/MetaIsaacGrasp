...
parser.add_argument("--input", type=str, default="models_ifl/*/textured.urdf", help="The path to the input URDF file.")
parser.add_argument("--output", type=str, default="models_ifl/*/orbit_obj.usd", help="The path to store the USD file.")
parser.add_argument(
    "--merge-joints",
    action="store_true",
    default=False,
